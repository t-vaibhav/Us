...
export default function Sidenav() {
    ...
    return (
        <section className='flex font-noto ' >
                    ...
                    <div className='relative'>
                        ...
                        <div className={`${learn ? '-translate-x-0' : '-translate-x-[250px]'} duration-500 pt-5`}>
                            <ul className={`${open ? 'w-[15vw]' : 'w-[2vw]'} ${open ? 'min-w-[15vw]' : 'min-w-[2vw]'} duration-300`} >
                                ...
                                <a href="#" className={``}><li className={`flex items-center h-12 text-md  hover:underline`}> <img src="/images/premium.png" alt="" className='h-5 w-5 mr-2' /> <p className={` ${open ? '-translate-x-0' : 'translate-x-[250px]'} duration-1000`}>{open ? 'Premium' : ''}</p></li></a>
            ...
            {learn ? <Main /> : <Learn college={col} res={res} ler={ler} />}
